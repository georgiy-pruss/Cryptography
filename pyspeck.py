...
if __name__== '__main__':
  ...
  print( "1/10 tests are passed", end='\r' )
  ...
  print( "2/10 tests are passed", end='\r' )
  ...
  print( "3/10 tests are passed", end='\r' )
  ...
  print( "4/10 tests are passed", end='\r' )
  ...
  print( "5/10 tests are passed", end='\r' )
  ...
  print( "6/10 tests are passed", end='\r' )
  ...
  print( "7/10 tests are passed", end='\r' )
  ...
  print( "8/10 tests are passed", end='\r' )
  ...
  print( "9/10 tests are passed", end='\r' )
