...
# old, online: https://repl.it/7sZ * all copyright (C) 2016 G.Pruss

# 6 lengths of 'groups' - in rfc.
# 1536 2048 3072 4096 6144 8192 bits

# exported fns:
# set_modp( k: int ):                 k is length in bits, see above
# make_pub( a: int ) -> int:          a is secret key; the result is public key
# make_key( gb: int, a: int ) -> int: gb is from 2nd party, a is our secret key

_p = 0 # modulo. don't use it outside!
...
def make_pub( a: int ) -> int: # a is secret; the result is not - it's public key
